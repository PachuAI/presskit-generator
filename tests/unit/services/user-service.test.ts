...
describe("UserService", () => {
  ...
  describe("updateUserProfile", () => {
    ...
    it("should throw error when user not authenticated", async () => {
      ...
      await expect(UserService.updateUserProfile({ artist_name: "Test" })).rejects.toThrow("User not authenticated")
    })
    ...
    it("should throw error for update failures", async () => {
      ...
      await expect(UserService.updateUserProfile({ artist_name: "Test" })).rejects.toThrow(
  ...
  describe("deleteUserProfile", () => {
    ...
    it("should throw error when user not authenticated", async () => {
      ...
      await expect(UserService.deleteUserProfile()).rejects.toThrow("User not authenticated")
    })
    ...
    it("should throw error for delete failures", async () => {
      ...
      await expect(UserService.deleteUserProfile()).rejects.toThrow("Failed to delete user profile: Delete failed")
    })
  })
  ...
  describe("getUserProfileByEmail", () => {
    ...
    it("should throw error for database errors", async () => {
      ...
      await expect(UserService.getUserProfileByEmail("test@example.com")).rejects.toThrow(
        "Failed to get user profile by email: Database error"
      )
    })
  })
})
